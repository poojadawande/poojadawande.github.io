<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pharmaceutical_Packaging.aspx.cs" Inherits="Pharmaceutical_Packaging" %>
...
<head>
 ...
 <meta name="keywords" content="pharmaceuticals,pharnaceuticals packaging">
<title>Globe Print n Pack | Pharmaceutical_Packaging</title>
...
<a href="Promotional_Packaging.aspx">Promotional</a>
 ...
 <div id="portfolio">
<div id="wrapper">
 <section id="pharma" class="tab-content active">
<div>
<h1>Pharmaceuticals</h1>
 
 <ul id="Ul5" class="clearfix">
 <li><a href="img/large/pantakind.jpg" ><img src="img/product/pantakind.jpg" alt="Pantakind"></a></li>
 <li><a href="img/large/orthoboon.jpg" ><img src="img/product/orthoboon.jpg" alt="Orthoboon"></a></li>
 <li><a href="img/large/maxical_high.jpg" ><img src="img/product/maxical_high_small.jpg" alt="maxical_high"></a></li>
 
 <li><a href="img/large/kamagra.jpg" ><img src="img/product/kamagra_small.jpg" alt="kamagra"></a></li>  
  <li><a href="img/large/global777.jpg" ><img src="img/product/global777_small.jpg" alt="global777"></a></li>

 
  <li><a href="img/large/himalaya_pack2.jpg" ><img src="img/product/himalaya_pack2_small.jpg" alt="himalaya pack 2"></a></li>
 
 
 <li><a href="img/large/dr.batras product set.jpg" ><img src="img/product/dr.batras product set_small.jpg" alt="dr.batras product set"></a></li>

 <li><a href="img/large/Glucovita_bolts.jpg" ><img src="img/product/Glucovita_bolts_small.jpg" alt="Glucovita_bolts"></a></li>
 
  <li><a href="img/large/periset_endcap_box.jpg" ><img src="img/product/periset_endcap_box_small.jpg" alt="periset_endcap_box"></a></li> 

 <li><a href="img/large/voveran 50GE.jpg" ><img src="img/product/voveran 50GE_small.jpg" alt="voveran 50GE"></a></li>

 <li><a href="img/large/Orthotrue.jpg" ><img src="img/product/Orthotrue_small.jpg" alt="Orthotrue"></a></li>
 </ul>
</div>
</section>
