<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Danglers.aspx.cs" Inherits="Danglers" %>
...
<head>
 ...
 <meta name="keywords" content="Danglers" />
<title>Globe Print n Pack | Danglers</title>
...
<li><a href="csr.aspx"><i class="fa fa-handshake-o"></i> CSR</a></li>
 ...
 <img src="images/line.png" class="navbar-brand line">
</nav>
...
<a href="Promotional_Packaging.aspx">Promotional</a>
 ...
 <div id="portfolio">
<div id="wrapper">
 <section id="danglers" class="tab-content active">
<div>
 <h1>Danglers</h1>
 
 <ul id="Ul8" class="clearfix">
 
 <li><a href="img/large/lg.jpg" ><img src="img/product/lg_samll.jpg" alt="lg dangler" ></a></li>
 
 <li><a href="img/large/Hanes_hanger.jpg" ><img src="img/product/Hanes_hanger_small.jpg" alt="Hanes Hanger"></a></li>
 
 <li><a href="img/large/Reliance_cube.jpg"><img src="img/product/Reliance_cube_small.jpg" alt="Reliance_cube"></a></li>
 
 <li><a href="img/large/Loop.jpg" ><img src="img/product/Loop_small.jpg" alt="Loop"></a></li>
 
 <li><a href="img/large/kissan.jpg"><img src="img/product/kissan_small.jpg" alt="kissan"></a></li> 

 <li><a href="img/large/Paddle_pop.jpg"><img src="img/product/Paddle_pop_small.jpg" alt="Paddle_pop"></a></li>

 <li><a href="img/large/vodafone_cube.jpg" ><img src="img/product/vodafone_cube_small.jpg" alt="vodafone_cube"></a></li> 
 
 <li><a href="img/large/fevikwik.jpg" ><img src="img/product/fevikwik_small.jpg" alt="fevikwik"></a></li>

 <li><a href="img/large/westa_trirama.jpg" ><img src="img/product/westa_trirama_small.jpg" alt=""></a></li>
 
 
 <li><a href="img/large/Bunting.jpg" ><img src="img/product/Bunting_small.jpg" alt="Bunting"></a></li> 
