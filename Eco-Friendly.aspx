<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Eco-Friendly.aspx.cs" Inherits="Eco_Friendly" %>
...
<head>
 ...
 <meta name="keywords" content="Ecofriendly,enviornment"/>
 <meta name="description" content="When producing plastic packaging the environment needs to be considered more than ever." />
 <title>Globe Print n Pack | Eco-Friendly</title> 
...
<li><a onclick="('images/Globe Print n Pack.pdf')" href="images/Globe Print n Pack.pdf" download="Globe Print n Pack.pdf" ><i class="fa fa-download" aria-hidden="true"></i> BROCHURE </a></li>
 ...
 <img src="images/line.png" class="navbar-brand line" alt="Line"/>
</nav>
 ...
 <div id="eco">
 <div class="col-md-9">
 <h2 style="font-size: x-large;">Eco Friendly</h2>
 <hr style="border-top: 2px solid #d43133"/>
<br />
<div id="slideshow">
 
 <div>
 <img src="images/Enviornment.jpg" alt="Enviornment" />
 </div>
 
</div>
<p>When producing plastic packaging the environment needs to be considered more
than ever.</p>
<p>Our industry has taken several initiatives on improving the impact that packaging 
has on the environment and Globe Print n Pack have gone further still to reduce 
waste in production and increase recycling after use.</p>
<p>How we contribute to reduce carbon footprint?</p>
<ul> 
<li>We manufacture PET boxes which requires energy less than that of 
production for PVC.</li>
<li> We transport all our product in sheet form thus reducing transportation cost, 
time and CO2 emission at the same time. </li>
</ul>
<p>Some features of our products are: </p>
<ul>
<li>They do not contain any Heavy metals or Chloro-Floro Hydrocarbons</li>
<li>They are suitable for Food contact</li>
<li>Available in both virgin and recycled grades (RPET, RETRAN)</li>
<li>Can be recycled many times over without impairing its properties</li>
</ul>
</div>
 <div class="col-md-3" style=" width:15%; padding: 0px; padding-bottom: 150px; border-width: thin; margin-top: 10px; margin-left: 50px;">
...
<ul style="padding-top: 50px;font-size: 16px;">
 ...
 <li style="padding: 5px;"><a href="Eco-Friendly.aspx" class="active">Eco Friendly</a></li>
